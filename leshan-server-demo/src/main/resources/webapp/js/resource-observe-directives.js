angular.module('resourceObserveDirectives', [])

.directive('resourceObserve', function($compile, $routeParams, $http, dialog, $filter, lwResources, $modal, helper) {
	return {
		restrict: "E",
		replace: true,
		scope: {
		...
		templateUrl: "partials/resource-observe.html",
